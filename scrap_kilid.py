...
headers = {
  ...
  'referer': 'https://kilid.com/buy/tehran?locations=c_2301021576&subType=buy&type=listing&sort=kilid,DESC&numBedJoinComma=3,',
}
...
def scrap_kilid():
    for i in range(100):
        ...
        response = requests.request("POST", "https://api.kilid.com/api/listing/search/portal/v2.0?page=" + str(i) + "&sort=kilid,DESC&numBedJoinComma=3,", headers=headers, data = '{"locations":[{"type":"city","locationId":"2301021576"}],"subType":"buy","type":"listing","page":"' + str(i) + '","sort":"kilid,DESC", "numBedJoinComma": "3,"}')
